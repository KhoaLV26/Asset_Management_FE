...
const EditUser = () => {
    ...
    useEffect(() => {
        ...
        axiosInstance
            ...
            .then((response) => {
                if (response.data.success === true) {
                    form.setFieldsValue({ ...response.data.data, dateOfBirth: response.data.data.dateOfBirth ? dayjs(response.data.data.dateOfBirth, "YYYY-MM-DD") : null, dateJoined: response.data.data.dateJoined ? dayjs(response.data.data.dateJoined, "YYYY-MM-DD") : null })
                    setIsLoading(false);
                } else {
                    message.error(response.data.message);
                }
