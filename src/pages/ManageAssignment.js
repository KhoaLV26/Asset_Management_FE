    ...
    const columns = [
        {
            ...
            dataIndex: "index",
            key: "index",
            render: (text, record, index) => <span>{params.sortOrder === "asc" ? index + 1 + ((params?.pageNumber - 1) * 10) : ((params?.pageNumber - 1) * 10) - index - 1}</span>
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="middle">
                    ...
                    >
                        <RedoOutlined className="text-blue-600 text-lg mb-1" />
                    </Button>
                </Space>
            ),
        },
